...
public class CameraManager : MonoBehaviour
{
    ...
    public float mininumPivotAngle = -10;
    public float maximumPivotAngle = 10;
    private void Awake()
    {
    ...
    private void HandleCameraCollisions()
    {
        ...
        if (Physics.SphereCast
            (cameraPivot.transform.position, cameraCollisionRadius, direction, out hit, Mathf.Abs(targetPosition), collisionLayers)) //creates invisible sphere around object we want, then fires out in the direction we just made
        {
